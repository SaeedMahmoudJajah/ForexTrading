...
|------|-------|--------|-------|
| **1** | **Foundations** | ✅ **Available** | Everything in this repo — the complete from-scratch starter |
| 2 | *(planned)* | 🔜 | e.g. Technical analysis & chart mastery — deep dive |
| 3 | *(planned)* | 🔜 | e.g. Strategy development, backtesting & journaling systems |
| 4 | *(planned)* | 🔜 | e.g. Advanced risk, psychology & building a routine |

> Volume topics above are placeholders — we'll refine them as we build. Each volume gets its own PDF in [dist/](dist/), generated by the shared builder in [build/](build/).
